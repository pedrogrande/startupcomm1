...
class EnquiriesControllerTest < ActionController::TestCase
  ...
  test "should create enquiry" do
    assert_difference('Enquiry.count') do
      post :create, enquiry: { email: @enquiry.email, message: @enquiry.message, message_type: @enquiry.message_type, name: @enquiry.name, phone: @enquiry.phone }
    end
  ...
  test "should update enquiry" do
    patch :update, id: @enquiry, enquiry: { email: @enquiry.email, message: @enquiry.message, message_type: @enquiry.message_type, name: @enquiry.name, phone: @enquiry.phone }
    assert_redirected_to enquiry_path(assigns(:enquiry))
  end
